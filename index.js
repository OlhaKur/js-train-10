...
function customAssign(...objects) {
  ...
  for (let prop in mergedObject) {
    if (typeof mergedObject[prop] === "number") {
      mergedObject[prop] = String(mergedObject[prop]);
    }

    if (typeof mergedObject[prop] === "string") {
      mergedObject[prop] = mergedObject[prop].replace(/ /g, "_");
    }
  }
...
function checkOwnership(obj1, obj2, key) {
  let object1 = obj1.hasOwnProperty(key);
  let object2 = obj2.hasOwnProperty(key);
